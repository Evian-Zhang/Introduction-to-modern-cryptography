...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.8]{chapters/chapter_4/Feistel.eps}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.5]{chapters/chapter_4/IDEA_round.eps}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.5]{chapters/chapter_4/IDEA_output.png}
\end{figure}
